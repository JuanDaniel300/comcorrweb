...
export default function RegisterView() {
    ...
    const onSubmit = async (data: any) => {
        ...
        try {
            console.log("Datos completos del registro:", data)
            ...
            <div className="flex-1 w-full md:w-[50%] h-full m-auto flex items-center justify-center md:justify-end p-4">
                ...
                >
                    ...
                    <div className="flex items-center justify-between w-full mb-4">
                        ...
                        <div className="text-xl text-secundario font-semibold">{step}/2</div>
                    </div>
                        ...
                        >
                            <FormProvider {...methods}>
                                <form onSubmit={methods.handleSubmit(onSubmit)}>
                                    ...
                                    {step === 2 && <RegisterStep2 handle={handleNextStep} isSubmitting={isSubmitting} />}
                                </form>
                            </FormProvider>
                        </motion.div>
                    </AnimatePresence>
            ...
            <div className="w-full md:w-[50%] flex-1 h-full m-auto flex items-center bg-transparent p-8">
                <div className="w-full max-w-xl mx-auto">
                    ...
                    <div className="w-full mt-10">
                        <div className="text-primario font-semibold text-2xl mb-4">Beneficios</div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <div className="text-primario font-semibold">Compra Fácil y Segura</div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div className="text-primario font-semibold">Promociones Exclusivas</div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div className="text-primario font-semibold">Opciones de Pago</div>
                            </motion.div>
                        </div>
                    </div>
                </div>
