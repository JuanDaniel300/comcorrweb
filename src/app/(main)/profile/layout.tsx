        ...
        <div className="min-h-screen bg-gray-100 p-4 padding-top">
            <div className="container mx-auto py-10">
                <div className="flex flex-col md:flex-row">
                    {/* Sidebar */}
                    <aside className="w-full sm:w-80 border-r border-gray-300 min-h-screen pe-6 py-6">
                        <div className="mb-8">
                            <Link href="/profile">
                            ...
                            <p className="text-[var(--oscuro2)] text-sm">
                                Gracias por ser parte de <span className="text-primario font-bold">Comcorr</span>.
                            </p>
                        </div>
                        ...
                        <nav className="space-y-6">
                            ...
                            {/* Administrar cuenta */}
                            <div>
                                <h3 className="font-medium text-[var(--oscuro1)] mb-2">Administrar cuenta</h3>
                                <div className="space-y-2">
                                    <Link
                                        href="/profile"
                            ...
                            {/* Privacidad */}
                            <div>
                                <h3 className="font-medium text-[var(--oscuro1)] mb-2">Privacidad</h3>
                                <div className="space-y-2">
                                    <Link
                            ...
                            {/* Servicio al cliente */}
                            <div>
                                <h3 className="font-medium text-[var(--oscuro1)] mb-2">Servicio al cliente</h3>
                                <div className="space-y-2">
                                    <Link
