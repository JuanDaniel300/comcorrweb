  ...
  return (
    <Fragment>
      <motion.div
        ...
        className="rounded-xl p-6  bg-white w-[90%] m-auto sm:w-[544px] h-max  shadow-md"
      >
        ...
        <motion.div
          ...
          className="w-full"
        >
          <div className="text-lg sm:text-2xl font-semibold py-6">
            Nos alegra verte otra vez
          </div>

          <div className="font-[600] sm:pr-20 text-xs sm:text-base text-oscuro2">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="w-full my-6">
            <div className="mb-3 flex flex-wrap">
              <label
                htmlFor="email"
                className="w-full font-semibold mb-2 text-xs sm:text-base"
              >
                Correo
              </label>
              <input
                className="border-2 border-gray-200 w-full rounded-lg px-2 py-2 text-xs sm:text-base"
          ...
          <div className="space-y-4 w-full">
            <motion.button className="bg-white text-xs sm:text-base border cursor-pointer border-gray-300 text-gray-700 rounded-lg py-2 w-full flex justify-center gap-3 items-center">
