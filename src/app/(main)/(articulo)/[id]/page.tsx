            ...
            <div className="container mx-auto py-10">
                ...
                <div className="w-full product__container h-max">
                    <div className="grid grid-cols-2 gap-20">
                        {/* Galería de imágenes */}
                        <ArticuloGalery images={[product.imagen1, product.imagen2, product.imagen3].filter(Boolean)} />
                        ...
                        <div className="product__details">
                                ...
                                <div className="product__promotion mb-10">
                                    {
                                        hasPromotion && (
                                            <div className="flex items-center gap-2 bg-secundario w-max rounded-lg px-2 absolute z-10">
                                                ...
                                                <span className="text-lg text-white font-medium ">¡Oferta!</span>
                                            </div>
                                        )
                                    }
                                </div>
                            ...
                            <div className="w-full space-y-4">
                                <div className="product__marca font-[600] text-lg">{product.marca}</div>
                                <div className="product__nombre text-2xl font-bold uppercase">{productTitle}</div>
                                <div className="product__sku text-oscuro2 font-[500]">{product.codigo}</div>
                                ...
                                <div className="product__description">
                                    ...
                                    <div className="text-sm font-[400]">
                                        {product.descripcion || "No se proporcionó una descripción para este producto."}
                                    </div>
                                </div>
